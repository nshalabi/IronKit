...
namespace IronPython.Runtime.Types {
    ...
    public abstract class PythonCustomTracker : CustomTracker {
        ...
        public override DynamicMetaObject GetBoundValue(OverloadResolverFactory factory, ActionBinder binder, Type instanceType, DynamicMetaObject instance) {
        ...
        public override DynamicMetaObject SetBoundValue(OverloadResolverFactory resolverFactory, ActionBinder binder, Type type, DynamicMetaObject value, DynamicMetaObject instance) {
            return SetBoundValue(resolverFactory, binder, type, value, instance, null);
        }

        public override DynamicMetaObject SetBoundValue(OverloadResolverFactory factory, ActionBinder binder, Type type, DynamicMetaObject value, DynamicMetaObject instance, DynamicMetaObject errorSuggestion) {
            return new DynamicMetaObject(
